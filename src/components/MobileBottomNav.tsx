...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = React.memo(({ currentPage, onPageChange }) => (
  <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50" style={{ background: 'linear-gradient(to top, #0a0b0f 80%, rgba(10,11,15,0.97))', borderTop: '1px solid rgba(255,255,255,0.07)', boxShadow: '0 -4px 24px rgba(0,0,0,0.5)', paddingBottom: 'env(safe-area-inset-bottom)' }}>
