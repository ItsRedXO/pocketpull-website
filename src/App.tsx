...
import { PokeBrawlPage } from './pages/PokeBrawlPage';
...
export default function App() {
  ...
  const handlePageChange = useCallback((page: string) => {
    if (['home', 'upgrader', 'battle', 'exchanger', 'inventory', 'profile', 'vault', 'brawl'].includes(page)) setCurrentPage(page as Page);
  }, []);
