...
import { Package, LogOut, Shield, ShieldCheck, CheckCircle, AlertCircle, Users, BarChart3, History, Home, MessageCircle, Banknote, FileText, Mail, Swords, SlidersHorizontal } from 'lucide-react';
...
type Tab = 'packs' | 'users' | 'pulls' | 'stats' | 'support' | 'cashouts' | 'logs' | 'emails' | 'provably-fair' | 'brawl' | 'site-settings';
