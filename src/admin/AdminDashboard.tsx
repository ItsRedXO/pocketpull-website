...
import { Package, LogOut, Shield, ShieldCheck, CheckCircle, AlertCircle, Users, BarChart3, History, Home, MessageCircle, Banknote, FileText, Mail, Swords } from 'lucide-react';
...
type Tab = 'packs' | 'users' | 'pulls' | 'stats' | 'support' | 'cashouts' | 'logs' | 'emails' | 'provably-fair' | 'brawl';
