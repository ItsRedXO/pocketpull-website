...
app.route('/', brawlRoutes); app.route('/', adminBrawlRoutes); app.route('/', siteSettingsRoutes); app.route('/', activityPingRoutes); app.route('/', adminEmailsRoutes); app.route('/', promoCodesRoutes);
