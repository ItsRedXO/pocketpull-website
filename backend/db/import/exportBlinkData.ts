...
const TABLE_TO_SDK: Record<string, string> = {
  users:'users', packs_catalog:'packsCatalog', pack_cards:'packCards', inventory:'inventory',
  transactions:'transactions', packs_opened:'packsOpened', server_seeds:'serverSeeds',
  pack_odds_versions:'packOddsVersions', user_nonces:'userNonces', pack_cooldowns:'packCooldowns',
  admin_credentials:'adminCredentials', upgrader_multiplier_settings:'upgraderMultiplierSettings',
  upgrader_spins:'upgraderSpins', battles:'battles', battle_players:'battlePlayers',
  battle_participants:'battleParticipants', battle_results:'battleResults', battle_pull_audits:'battlePullAudits',
  upgrader_settings:'upgraderSettings', upgrader_history:'upgraderHistory', exchanger_activity:'exchangerActivity',
  cashout_requests:'cashoutRequests', cashouts:'cashouts', activity_logs:'activityLogs', outbound_emails:'outboundEmails',
